...
public class PlayerDCPreface extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_player_dcpreface);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Dickens_Carol%2Fdc_preface.wav?alt=media&token=6235e959-8f97-4c35-919b-ff8bf0de11a3";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
