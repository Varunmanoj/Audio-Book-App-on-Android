...
public class DCStave1 extends AppCompatActivity {
    TextView Percent;
    SeekBar sk;
    ImageButton play;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcstave1);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Dickens_Carol%2Fdc_stave1.wav?alt=media&token=17bc2b49-04df-438c-ab71-9d7daef1955e";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
