...
public class pchap4 extends AppCompatActivity {
    TextView Percent;
    SeekBar sk;
    ImageButton play;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pchap4);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Pinocchio%2Fp_chapter4.wav?alt=media&token=393c5af2-9612-4e0d-b7cd-7e0855394aa1";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
