...
public class Pchap1 extends AppCompatActivity {
    TextView Percent;
    SeekBar sk;
    ImageButton play;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pchap1);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Pinocchio%2Fp_chapter1.wav?alt=media&token=36886ed1-bbb4-46f8-ac61-c15539429c89";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
