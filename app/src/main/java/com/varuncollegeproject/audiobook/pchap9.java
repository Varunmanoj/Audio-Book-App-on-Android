...
public class pchap9 extends AppCompatActivity {
    TextView Percent;
    SeekBar sk;
    ImageButton play;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pchap9);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Pinocchio%2Fp_chapter9.wav?alt=media&token=c74c4259-b9f6-457a-b656-26a6284bef20";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
