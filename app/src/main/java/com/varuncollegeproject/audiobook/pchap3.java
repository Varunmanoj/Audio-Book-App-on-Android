...
public class pchap3 extends AppCompatActivity {
    TextView Percent;
    SeekBar sk;
    ImageButton play;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pchap3);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Pinocchio%2Fp_chapter3.wav?alt=media&token=fa2d8b4c-5eed-4e89-9674-f669cc7a39af";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
