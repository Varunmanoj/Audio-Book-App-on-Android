...
public class DCStave4 extends AppCompatActivity {
    TextView Percent;
    SeekBar sk;
    ImageButton play;
    MediaPlayer mp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dcstave4);
...
//        Click buttons
    ...
    public void CreateAudio() {
        String TitleURL = "https://firebasestorage.googleapis.com/v0/b/here-me-audio-book.appspot.com/o/Dickens_Carol%2Fdc_stave4.wav?alt=media&token=07daec51-caf1-4392-bec0-594670e1bc86";
        //Play Audio
        if (mp == null) {
            mp = new MediaPlayer();
            try {
